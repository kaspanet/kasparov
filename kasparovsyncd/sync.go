...
func insertBlocks(dbTx *gorm.DB, blocks []*rawAndVerboseBlock, transactionIDsToTxWithMetaData map[string]*txWithMetaData) (blockHashesToID map[string]uint64, err error) {
